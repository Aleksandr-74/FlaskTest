...
with open('B:\git\pythonProjectNew\ФАЙЛ\character.csv', 'w', encoding='utf-8') as f:
    fieldnames = ['link']
...
with open('B:\git\pythonProjectNew\ФАЙЛ\character.csv', 'r', encoding='utf-8') as f:
    reader = csv.reader(f)
    ...
    def record(a):
        with open('B:\git\pythonProjectNew\ФАЙЛ\Marvel character.csv', 'a', encoding='utf-8') as f:
